...
$php_bin "$repo_root/tests/php/pipeline_workflow_contract.php"
$php_bin "$repo_root/tests/php/third_party_notice_contract.php"
...
$php_bin "$repo_root/tests/php/password_policy_security.php"
$php_bin "$repo_root/tests/php/self_registration_security.php"
...
$php_bin "$repo_root/tests/php/handbook_ui_security.php"
$php_bin "$repo_root/tests/php/workflow_security.php"
$php_bin "$repo_root/tests/php/workflow_single_dispatch_security.php"
...
$php_bin "$repo_root/tests/php/message_timeline_security.php"
$php_bin "$repo_root/tests/php/message_timeline_integration_security.php"
...
$php_bin "$repo_root/tests/php/ldf_return_security.php"
...
$php_bin "$repo_root/tests/php/telecom_plan_security.php"
$php_bin "$repo_root/tests/php/upload_security.php"
$php_bin "$repo_root/tests/php/attachment_security.php"
$php_bin "$repo_root/tests/php/email_attachment_security.php"
...
$php_bin "$repo_root/tests/php/permission_mode_security.php"
$php_bin "$repo_root/tests/php/permission_mode_attachment_scope_security.php"

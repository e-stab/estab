...
aw_code=${ESTAB_TEST_TBB_CODE:-e2aw00}
...
# Authentication must fail before any logbook data is rendered. Every
# authenticated function may read both books, while only S2/red-copy may write
# ETB and only the A/W Fernmelder may write TBB.

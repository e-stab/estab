...
function estab_readiness_schema_query(): string
{
    return "SELECT "
        ...
        . "'%assignment.`status` = BINARY ''ANGENOMMEN''%') OR "
        ...
        */
        ...
        . "AND ((SELECT COUNT(*) FROM estab_schema_migrations) = 23) "

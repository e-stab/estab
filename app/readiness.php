...
function estab_readiness_schema_query(): string
{
    return "SELECT "
        ...
        . "'nv_tbb','nv_ubb','nv_bhp50','nv_etbtitel','nv_tbbtitel',"
        ...
        . "'nv_protokoll','nv_bhp50','nv_etbtitel','nv_tbbtitel')) = 9) "
        ...
        . "AND routine_definition LIKE '%FOR UPDATE%' AND routine_name IN ("
        . "'estab_incident_for_insert','estab_incident_for_update',"
        . "'estab_incident_for_delete')) = 3) "
        ...
        . "'fk_bhp50_einsatz','fk_etbtitel_einsatz',"
        . "'fk_tbbtitel_einsatz')) = 11) "
        ...
        // Ein Weg ohne Kennung bricht jeden Verweis, der auf ihr aufbaut.
        . "AND ((SELECT COUNT(*) FROM nv_fernmeldeplan_eintraege AS eintrag "
        ...
        . "AND column_name IN ('verfasser_funktion','vs_vermerk',"
        . "'freigabe_dienststellung') AND is_nullable = 'YES') = 3) "
        // Auch der Eingang nennt seinen Weg -- der Plan hoert sonst nie zurueck.
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() AND table_name = 'nv_nachrichten' "
        . "AND column_name IN ('estab_eingangsweg_bemerkung',"
        . "'estab_gegenstelle_id') AND is_nullable = 'YES') = 2) "
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() AND table_name = 'nv_nachrichten' "
        ...
        . "AND action_statement LIKE "
        . "'%Invalid duty assignment acceptance%') = 1) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() "
        ...
        . "AND column_name = 'objekttyp' AND ordinal_position = 4 "
        . "AND data_type = 'enum' AND column_type = "
        . "'enum(''DIENSTSCHICHT'',''DIENSTBESETZUNG'',"
        . "''DIENSTUEBERGABE'',''FERNMELDEPLAN'',''MELDERAUFTRAG'',"
        . "''EINSATZ'',''ZUGANGSSCHICHT'')' "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        . "AND is_nullable = 'NO' AND column_default IS NULL "
        . "AND extra = '' AND column_comment = "
        ...
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() AND table_name IN ("
        . "'nv_zugangsschichten','nv_zugangsschicht_mitglieder')) = 18) "
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        ...
        . "(column_name = 'einsatz_id' AND ordinal_position = 2 "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'NO') OR "
        . "(column_name = 'bezeichnung' AND ordinal_position = 3 "
        . "AND data_type = 'varchar' AND character_maximum_length = 100 "
        . "AND is_nullable = 'NO') OR "
        . "(column_name IN ('beginn','ende') "
        . "AND ordinal_position IN (4,5) AND data_type = 'datetime' "
        . "AND datetime_precision = 6 AND is_nullable = 'YES') OR "
        . "(column_name = 'zugang_aktiv' AND ordinal_position = 6 "
        . "AND data_type = 'tinyint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'NO' AND column_default = '0') OR "
        . "(column_name IN ('erstellt_am','geaendert_am') "
        . "AND ordinal_position IN (7,9) AND data_type = 'datetime' "
        . "AND datetime_precision = 6 AND is_nullable = 'NO') OR "
        . "(column_name IN ('erstellt_von','geaendert_von') "
        . "AND ordinal_position IN (8,10) AND data_type = 'varchar' "
        . "AND character_maximum_length = 128 "
        . "AND is_nullable = 'NO'))) OR "
        . "(table_name = 'nv_zugangsschicht_mitglieder' AND ("
        ...
        . "AND extra = 'auto_increment') OR "
        . "(column_name = 'zugangsschicht_id' AND ordinal_position = 2 "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'NO') OR "
        . "(column_name = 'benutzer_kuerzel' AND ordinal_position = 3 "
        . "AND data_type = 'varchar' AND character_maximum_length = 6 "
        . "AND is_nullable = 'NO') OR "
        . "(column_name = 'zugeordnet_am' AND ordinal_position = 4 "
        . "AND data_type = 'datetime' AND datetime_precision = 6 "
        . "AND is_nullable = 'NO') OR "
        . "(column_name = 'zugeordnet_von' AND ordinal_position = 5 "
        . "AND data_type = 'varchar' AND character_maximum_length = 128 "
        . "AND is_nullable = 'NO') OR "
        . "(column_name = 'entfernt_am' AND ordinal_position = 6 "
        . "AND data_type = 'datetime' AND datetime_precision = 6 "
        . "AND is_nullable = 'YES') OR "
        . "(column_name = 'entfernt_von' AND ordinal_position = 7 "
        . "AND data_type = 'varchar' AND character_maximum_length = 128 "
        . "AND is_nullable = 'YES') OR "
        . "(column_name = 'aktives_benutzer_kuerzel' "
        . "AND ordinal_position = 8 AND data_type = 'varchar' "
        . "AND character_maximum_length = 6 AND is_nullable = 'YES' "
        . "AND extra LIKE '%STORED GENERATED%' "
        . "AND generation_expression LIKE '%entfernt_am%' "
        . "AND generation_expression LIKE '%benutzer_kuerzel%'))))) = 18) "
        . "AND ((SELECT COUNT(*) FROM information_schema.statistics "
        ...
        . "AND column_name = 'einsatz_id') OR (seq_in_index = 2 "
        . "AND column_name = 'bezeichnung'))) OR "
        . "(table_name = 'nv_zugangsschichten' "
        . "AND index_name = 'idx_zugangsschicht_aktiv' "
        . "AND non_unique = 1 AND ((seq_in_index = 1 "
        . "AND column_name = 'einsatz_id') OR (seq_in_index = 2 "
        . "AND column_name = 'zugang_aktiv') OR (seq_in_index = 3 "
        . "AND column_name = 'zugangsschicht_id'))) OR "
        . "(table_name = 'nv_zugangsschicht_mitglieder' "
        . "AND index_name = 'uq_zugangsschicht_aktives_mitglied' "
        . "AND non_unique = 0 AND ((seq_in_index = 1 "
        . "AND column_name = 'zugangsschicht_id') OR (seq_in_index = 2 "
        . "AND column_name = 'aktives_benutzer_kuerzel'))) OR "
        . "(table_name = 'nv_zugangsschicht_mitglieder' "
        . "AND index_name = 'idx_zugangsschicht_mitglied_benutzer' "
        . "AND non_unique = 1 AND ((seq_in_index = 1 "
        . "AND column_name = 'benutzer_kuerzel') OR (seq_in_index = 2 "
        . "AND column_name = 'entfernt_am'))))) = 9) "
        . "AND ((SELECT COUNT(*) "
        ...
        . "AND relation.delete_rule = 'RESTRICT' AND ("
        ...
        . "AND key_column.referenced_column_name = 'einsatz_id') OR "
        . "(relation.table_name = 'nv_zugangsschicht_mitglieder' "
        ...
        . "AND key_column.referenced_column_name = 'zugangsschicht_id') OR "
        . "(relation.table_name = 'nv_zugangsschicht_mitglieder' "
        . "AND relation.constraint_name = "
        ...
        . "AND key_column.referenced_column_name = 'kuerzel'))) = 3) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        ...
        . "AND action_statement LIKE '%creator_extra%') OR "
        ...
        . "AND action_statement LIKE '%release_extra%') OR "
        ...
        . "AND action_statement LIKE '%supervisor_extra%') OR "
        ...
        . "AND action_statement LIKE '%report_extra%'))) = 4) "
        . "AND ((SELECT COUNT(*) FROM information_schema.tables "
        . "WHERE table_schema = DATABASE() "
        ...
        . "AND is_nullable = 'NO' AND column_default = '0' "
        . "AND column_comment = "
        . "'estab:migration:110:etb-book-number:v1') OR "
        . "(table_name = 'nv_tbb' AND column_name = 'estab_book_lfd' "
        . "AND data_type = 'int' AND column_type LIKE 'int%unsigned' "
        . "AND is_nullable = 'NO' AND column_default = '0' "
        . "AND column_comment = "
        . "'estab:migration:110:tbb-book-number:v1') OR "
        . "(table_name = 'nv_tbb' AND column_name IN ("
        . "'estab_event_time','estab_recorded_at') "
        . "AND data_type = 'datetime' AND datetime_precision = 6 "
        . "AND is_nullable = 'NO') OR "
        . "(table_name = 'nv_tbb' AND column_name = 'estab_entry_type' "
        . "AND data_type = 'varchar' AND character_maximum_length = 32 "
        . "AND is_nullable = 'NO') OR "
        . "(table_name = 'nv_tbb' AND column_name = 'estab_message_id' "
        . "AND data_type = 'bigint' AND is_nullable = 'YES' "
        . "AND column_comment = 'estab:migration:110:tbb-message:v1') OR "
        . "(table_name = 'nv_tbb' AND column_name IN ("
        . "'estab_personnel_duty','estab_channel','estab_message_route',"
        . "'estab_operations','estab_receipt') "
        . "AND data_type = 'text' AND is_nullable = 'YES') OR "
        . "(table_name = 'nv_tbb' AND column_name = 'estab_correction_of' "
        . "AND data_type = 'int' AND is_nullable = 'YES'))) = 12) "
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() AND ("
        . "(table_name = 'nv_etb' AND column_name = 'estab_shift_id' "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:etb-shift:v1') OR "
        . "(table_name = 'nv_etb' "
        . "AND column_name = 'estab_writer_assignment_id' "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:etb-writer:v1') OR "
        . "(table_name = 'nv_etb' "
        . "AND column_name = 'estab_assignee_assignment_id' "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:etb-assignee:v1') OR "
        . "(table_name = 'nv_etb' AND column_name = 'estab_assignment' "
        . "AND data_type = 'varchar' AND character_maximum_length = 255 "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:etb-assignment-snapshot:v1') OR "
        . "(table_name = 'nv_tbb' AND column_name = 'estab_shift_id' "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:tbb-shift:v1') OR "
        . "(table_name = 'nv_tbb' "
        . "AND column_name = 'estab_writer_assignment_id' "
        . "AND data_type = 'bigint' AND column_type LIKE '%unsigned%' "
        . "AND is_nullable = 'YES' AND column_comment = "
        . "'estab:migration:111:tbb-writer:v1'))) = 6) "
        . "AND ((SELECT COUNT(*) FROM information_schema.statistics "
        . "WHERE table_schema = DATABASE() AND sub_part IS NULL AND ("
        . "(table_name = 'nv_etb' "
        . "AND index_name = 'uq_etb_einsatz_book_lfd' AND non_unique = 0 "
        . "AND ((seq_in_index = 1 AND column_name = 'einsatz_id') OR "
        . "(seq_in_index = 2 AND column_name = 'estab_book_lfd'))) OR "
        . "(table_name = 'nv_etb' AND index_name = 'uq_etb_attachment_id' "
        . "AND non_unique = 0 AND seq_in_index = 1 "
        . "AND column_name = 'estab_attachment_id') OR "
        . "(table_name = 'nv_tbb' "
        . "AND index_name = 'uq_tbb_einsatz_book_lfd' AND non_unique = 0 "
        . "AND ((seq_in_index = 1 AND column_name = 'einsatz_id') OR "
        . "(seq_in_index = 2 AND column_name = 'estab_book_lfd'))) OR "
        . "(table_name = 'nv_tbb' "
        . "AND index_name = 'idx_tbb_einsatz_event_time' "
        . "AND non_unique = 1 AND ("
        . "(seq_in_index = 1 AND column_name = 'einsatz_id') OR "
        . "(seq_in_index = 2 AND column_name = 'estab_event_time') OR "
        . "(seq_in_index = 3 AND column_name = 'tbb_lfd-nr'))) OR "
        . "(table_name = 'nv_tbb' AND index_name = 'idx_tbb_correction' "
        . "AND non_unique = 1 AND seq_in_index = 1 "
        . "AND column_name = 'estab_correction_of') OR "
        . "(table_name = 'nv_tbb' AND index_name = 'idx_tbb_message' "
        . "AND non_unique = 0 AND ((seq_in_index = 1 "
        . "AND column_name = 'einsatz_id') OR (seq_in_index = 2 "
        . "AND column_name = 'estab_message_id'))))) = 11) "
        . "AND ((SELECT COUNT(*) FROM information_schema.statistics "
        . "WHERE table_schema = DATABASE() AND sub_part IS NULL AND ("
        . "(table_name = 'nv_etb' "
        . "AND index_name = 'idx_etb_einsatz_shift_book' "
        . "AND non_unique = 1 AND index_type = 'BTREE' AND ("
        . "(seq_in_index = 1 AND column_name = 'einsatz_id') OR "
        . "(seq_in_index = 2 AND column_name = 'estab_shift_id') OR "
        . "(seq_in_index = 3 AND column_name = 'estab_book_lfd'))) OR "
        . "(table_name = 'nv_etb' "
        . "AND index_name = 'idx_etb_writer_assignment' "
        . "AND non_unique = 1 AND index_type = 'BTREE' "
        . "AND seq_in_index = 1 "
        . "AND column_name = 'estab_writer_assignment_id') OR "
        . "(table_name = 'nv_etb' "
        . "AND index_name = 'idx_etb_assignee_assignment' "
        . "AND non_unique = 1 AND index_type = 'BTREE' "
        . "AND seq_in_index = 1 "
        . "AND column_name = 'estab_assignee_assignment_id') OR "
        . "(table_name = 'nv_tbb' "
        ...
        . "AND non_unique = 1 AND index_type = 'BTREE' "
        . "AND seq_in_index = 1 "
        . "AND column_name = 'estab_writer_assignment_id'))) = 9) "
        . "AND ((SELECT COUNT(*) "
        . "FROM information_schema.referential_constraints "
        . "WHERE constraint_schema = DATABASE() "
        . "AND update_rule = 'RESTRICT' AND delete_rule = 'RESTRICT' AND ("
        . "(table_name = 'nv_logbuch_koepfe' "
        . "AND constraint_name = 'fk_logbuch_koepfe_einsatz' "
        . "AND referenced_table_name = 'nv_einsaetze') OR "
        . "(table_name = 'nv_tbb' AND constraint_name = 'fk_tbb_message' "
        . "AND referenced_table_name = 'nv_nachrichten') OR "
        . "(table_name = 'nv_tbb' AND constraint_name = 'fk_tbb_correction' "
        ...
        . "AND key_column.referenced_column_name = 'dienstschicht_id') OR "
        . "(relation.table_name = 'nv_etb' "
        ...
        . "AND relation.referenced_table_name = 'nv_dienstbesetzungen' "
        . "AND key_column.column_name = 'estab_writer_assignment_id' "
        . "AND key_column.referenced_column_name = 'dienstbesetzung_id'))) = 5) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() AND trigger_name IN ("
        ...
        . "'estab_tbb_bu_einsatz','estab_tbb_bd_einsatz')) = 9) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() "
        . "AND action_timing = 'BEFORE' "
        . "AND event_manipulation = 'INSERT' AND ("
        ...
        . "AND action_statement LIKE "
        . "'%nv_benutzer_zusatzfunktionen%') OR "
        . "(trigger_name = 'estab_tbb_bi_einsatz' "
        . "AND action_statement LIKE "
        . "'%TTB optional duty provenance must be complete%' "
        . "AND action_statement LIKE '%TTB writer duty provenance is invalid%' "
        /* Superseded migration-111 readiness marker:
        . "AND (TRUE OR action_statement LIKE "
        ...
        */
        ...
        . "AND ((SELECT COUNT(*) FROM nv_etb "
        . "WHERE einsatz_id IS NULL OR estab_book_lfd < 1) = 0) "
        . "AND ((SELECT COUNT(*) FROM nv_tbb "
        ...
        . ") IS NULL) OR (estab_message_id IS NOT NULL AND ("
        . "BINARY estab_entry_type <> BINARY 'nachricht' OR "
        . "BINARY COALESCE(tbb_kuerzel,'') <> BINARY 'system' OR "
        . "BINARY COALESCE(tbb_benutzer,'') <> BINARY 'eStab-System'"
        . "))) = 0) "
        . "AND ((SELECT COUNT(*) FROM nv_tbb AS entry_row "
        ...
        . "FROM nv_einsaetze AS incident_row LEFT JOIN nv_etb AS entry_row "
        . "ON entry_row.einsatz_id=incident_row.einsatz_id "
        . "GROUP BY incident_row.einsatz_id UNION ALL "
        . "SELECT incident_row.einsatz_id,'TTB' AS buchart,"
        . "COALESCE(MAX(entry_row.estab_book_lfd),0)+1 AS next_lfd "
        . "FROM nv_einsaetze AS incident_row LEFT JOIN nv_tbb AS entry_row "
        . "ON entry_row.einsatz_id=incident_row.einsatz_id "
        . "GROUP BY incident_row.einsatz_id"
        . ") AS expected LEFT JOIN nv_logbuch_koepfe AS head_row "
        ...
        . "AND ((SELECT COUNT(*) FROM nv_logbuch_koepfe) "
        ...
        . "WHERE table_schema = DATABASE() "
        . "AND table_name = 'nv_kennwortrichtlinie' "
        . "AND is_nullable = 'NO' AND extra = '' AND ("
        ...
        . "AND CONCAT(table_constraint.constraint_name,':',"
        . "SHA2(REPLACE(REPLACE(LOWER(check_constraint.check_clause),"
        . "'`',''),' ',''),256)) IN ("
        ...
        . ")) = 7) "
        . "AND ((SELECT COUNT(*) FROM nv_kennwortrichtlinie "
        . "WHERE singleton_id = 1 AND minimum_length BETWEEN 8 AND 128 "
        . "AND require_uppercase IN (0,1) "
        . "AND require_lowercase IN (0,1) "
        . "AND require_digit IN (0,1) AND require_symbol IN (0,1) "
        . "AND CHAR_LENGTH(updated_by) BETWEEN 1 AND 128) = 1) "
        . "AND ((SELECT COUNT(*) FROM nv_kennwortrichtlinie) = 1) "
        . "AND ((SELECT COUNT(*) FROM information_schema.tables "
        . "WHERE table_schema = DATABASE() "
        ...
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() "
        . "AND table_name = 'nv_selbstregistrierung' AND extra = '' AND ("
        . "(column_name = 'singleton_id' AND ordinal_position = 1 "
        . "AND is_nullable = 'NO' AND data_type = 'tinyint' "
        . "AND column_type LIKE 'tinyint%unsigned' "
        . "AND column_default IS NULL "
        . "AND column_comment = 'estab:migration:114:singleton:v1') "
        . "OR (column_name = 'mode' AND ordinal_position = 2 "
        . "AND is_nullable = 'NO' AND data_type = 'enum' "
        . "AND column_type = "
        ...
        . "OR (column_name = 'enabled_until_utc' AND ordinal_position = 3 "
        . "AND is_nullable = 'YES' AND data_type = 'datetime' "
        . "AND datetime_precision = 6 AND column_default = 'NULL' "
        . "AND column_comment = "
        . "'estab:migration:114:enabled-until-utc:v1') "
        . "OR (column_name = 'revision' AND ordinal_position = 4 "
        . "AND is_nullable = 'NO' AND data_type = 'bigint' "
        . "AND column_type LIKE 'bigint%unsigned' AND column_default = '0' "
        . "AND column_comment = 'estab:migration:114:revision:v1') "
        . "OR (column_name = 'updated_at' AND ordinal_position = 5 "
        . "AND is_nullable = 'NO' AND data_type = 'datetime' "
        . "AND datetime_precision = 6 "
        . "AND LOWER(column_default) = 'current_timestamp(6)' "
        . "AND column_comment = 'estab:migration:114:updated-at:v1') "
        . "OR (column_name = 'updated_by' AND ordinal_position = 6 "
        . "AND is_nullable = 'NO' AND data_type = 'varchar' "
        ...
        . ")) = 2) "
        . "AND ((SELECT COUNT(*) FROM nv_selbstregistrierung "
        ...
        . "AND ((SELECT COUNT(*) FROM nv_selbstregistrierung) = 1) "
        . "AND ((SELECT COUNT(*) FROM information_schema.columns "
        . "WHERE table_schema = DATABASE() "
        ...
        . "AND is_nullable = 'NO' "
        . "AND column_default = '''STRICT''' AND extra = '' "
        . "AND column_comment = "
        ...
        . "AND table_name = 'nv_benutzer_zusatzfunktionen' "
        . "AND is_nullable = 'NO' AND extra = '' AND ("
        . "(column_name = 'benutzer_kuerzel' AND ordinal_position = 1 "
        . "AND column_type = 'varchar(6)' "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        . "AND column_default IS NULL) OR "
        . "(column_name = 'funktion' AND ordinal_position = 2 "
        . "AND column_type = 'varchar(10)' "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        . "AND column_default IS NULL) OR "
        . "(column_name = 'rolle' AND ordinal_position = 3 "
        . "AND column_type = 'enum(''Stab'',''FB'',''Fernmelder'')' "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        . "AND column_default IS NULL) OR "
        . "(column_name = 'vergeben_am' AND ordinal_position = 4 "
        . "AND data_type = 'datetime' AND datetime_precision = 6 "
        . "AND LOWER(column_default) = 'current_timestamp(6)') OR "
        . "(column_name = 'vergeben_von' AND ordinal_position = 5 "
        . "AND column_type = 'varchar(128)' "
        . "AND character_set_name = 'utf8mb4' "
        . "AND collation_name = 'utf8mb4_unicode_ci' "
        ...
        . "AND ((SELECT COUNT(*) FROM information_schema.statistics "
        . "WHERE table_schema = DATABASE() "
        . "AND table_name = 'nv_benutzer_zusatzfunktionen' AND ("
        . "(index_name = 'PRIMARY' AND non_unique = 0 AND ("
        . "(seq_in_index = 1 AND column_name = 'benutzer_kuerzel') OR "
        . "(seq_in_index = 2 AND column_name = 'funktion'))) OR "
        . "(index_name = 'idx_benutzer_zusatzfunktion_funktion_rolle' "
        . "AND non_unique = 1 AND ("
        . "(seq_in_index = 1 AND column_name = 'funktion') OR "
        . "(seq_in_index = 2 AND column_name = 'rolle'))))) = 4) "
        . "AND ((SELECT COUNT(*) "
        . "FROM information_schema.referential_constraints "
        . "WHERE constraint_schema = DATABASE() "
        . "AND table_name = 'nv_benutzer_zusatzfunktionen' "
        ...
        . "AND update_rule = 'RESTRICT' AND delete_rule = 'CASCADE') = 1) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() AND ("
        ...
        . "OR (trigger_name IN ('estab_etb_bi_einsatz',"
        . "'estab_tbb_bi_einsatz','estab_dv94_fernmeldeplan_insert',"
        . "'estab_dv94_fernmeldeplan_immutable',"
        . "'estab_dv94_messenger_insert','estab_dv94_messenger_update') "
        . "AND action_statement LIKE '%estab_permission_mode%'))) = 8) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() "
        ...
        . "AND action_statement LIKE '%estab_dv_actor_assignment_id%' "
        . "AND action_statement LIKE '%estab_dv_target_assignment_id%'))) = 6) "
        . "AND ((SELECT COUNT(*) FROM information_schema.triggers "
        . "WHERE trigger_schema = DATABASE() "
        ...
        . "AND action_timing = 'BEFORE' "
        . "AND event_manipulation = 'UPDATE' "
        . "AND action_statement LIKE '%OLD.%ENTWURF%NEW.%ERSETZT%' "
        . "AND action_statement LIKE "
        . "'%OLD.`freigegeben_von` <=>%NEW.`freigegeben_von`%' "
        . "AND LOWER(action_statement) LIKE '%current_timestamp%' "
        . "AND LOWER(action_statement) NOT LIKE '%current_timestamp(6)%' "
        . "AND action_statement LIKE "
        . "'%Discarded telecommunications drafts are immutable evidence%') = 1) "
        . "AND ((SELECT COUNT(*) FROM nv_einsaetze "
        . "WHERE BINARY estab_permission_mode NOT IN ("
        . "BINARY 'STRICT',BINARY 'LOOSE')) = 0) "
        . "AND ((SELECT COUNT(*) FROM nv_einsaetze "

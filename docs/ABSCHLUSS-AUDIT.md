...
| Sicherer Containerstart | Gepinnte PHP-/MariaDB-Basen, 32 Schema-Prüfungen, checksumgebundene Migrationen, Health-Gates und getrennte Netze | vollständiger Podman-CI-Lauf und PHP-8.5-Suite |
...
Die abschließende statische PHP-8.5-Suite lintete 238 aktive PHP-Dateien.
...
Vor dem Abschlusscommit lag `main` zehn lokale Commits vor
`origin/main` (`aa32d1f`). Der Abschlusscommit erhöht diesen Abstand auf elf.

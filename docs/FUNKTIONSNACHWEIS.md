...
| Fresh-Baseline und Upgrade eines Legacy-Schemas | `tests/integration/schema_migrator.sh` | Ein checksumgebundener Abbruch wird idempotent bis zu allen 18 Migrationen fortgesetzt; unprotokollierte Teilbestände, Duplikate, fremde Objektkollisionen und Checksum-Manipulation blockieren ohne stilles Umschreiben. Migration 110 bindet lokale ETB-/TBB-Nummern und Append-only-Grenzen, Migration 111 ergänzt nullable historische Schicht-/Schreiberprovenienz. Migration 112 führt optionale Zugangsschichten ein und ersetzt den abschließenden Triggervertrag: aktiver Einsatz und feste fachlich passende Kontofunktion sind Pflicht, eine aktive Schicht oder Besetzungs-ID nicht. Veröffentlichte ältere Migrationen bleiben checksumstabil. |

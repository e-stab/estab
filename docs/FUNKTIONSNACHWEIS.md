...
| PHP-8.5-Laufzeit | `tests/static/run.sh` | 278 aktive PHP-Dateien einschließlich `app/permission_mode.php` linten; Kompatibilitäts- und Sicherheitsassertionen sind grün |
...
Die getrennte statische PHP-8.5-Suite endete mit Exitcode 0 und lintete 278
aktive PHP-Dateien.

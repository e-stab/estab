    ...
    if ($database !== false) {
        ...
        if ($connected) {
            ...
            $schemaResult = @$database->query(
                ...
                . "'nv_nachrichten','nv_empfmtx','nv_benutzer','nv_masterkatego',"
                . "'nv_masterkategolink','nv_protokoll','nv_anhang','nv_etb',"
                . "'nv_tbb','nv_ubb','nv_komplan','nv_bhp50','nv_etbtitel','nv_tbbtitel')) = 14) "
                ...
                . "AND ((SELECT COUNT(*) FROM estab_schema_migrations) = 2) "
